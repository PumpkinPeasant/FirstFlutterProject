...
class AppColor{
  ...
  static final Color homePageAccent = HexColor("#FCC91C");
  static final Color homePageSubtitle = HexColor("#E5E5E5");
  static final Color homePageDetail = HexColor("#828282");
  static final Color homePageIcons = HexColor("#8A8A8A");
}